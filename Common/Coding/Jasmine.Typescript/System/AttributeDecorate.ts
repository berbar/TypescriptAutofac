...
namespace System
{
    class CAttributeDecorateHelper
    {
        ...
        public static CheckTargetValidOn( attribute: CAttribute, usage: CAttributeUsage, target: UAttributeTarget ): void
        {
    ...
    export function AttributeDecorate( attribute: CAttribute ): UDecoratorFunctionType
    {
        ...
        {
            let attributeUsage = attribute.GetType().GetCustomAttributeOne( Reflection.TypeOf( CAttributeUsage ), true );
            if ( attributeUsage == null )
            {
                attributeUsage = CAttributeUsage.DefaultUsage;
            }
